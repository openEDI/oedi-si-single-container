...
fh = logging.FileHandler(os.path.join(baseDir,'logs','sensor_power_real.log'),mode='w')
fh.setFormatter(formatter)
fh.setLevel(10)
logger = logging.getLogger('sensor_power_real_logger')
logger.setLevel(10)
	...
	def simulate(self,simEndTime=24):
		...
		while grantedTime<simEndTime:
			...
			for entry in self.pub:
				h.__dict__[self.pub[entry]['method']](self.pub[entry]['indexObj'],json.dumps(pubData[entry]))
